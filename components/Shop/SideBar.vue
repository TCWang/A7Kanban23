...
const onChangeArea = (area) => {
  updateModal("area");
  navigateTo(`/area/${area}/shop/${route.params.typec}`);
};

const onChangeTypec = (typec) => {
  updateModal("typec");
  navigateTo(`/area/${route.params.area}/shop/${typec}`);
};

const onChangeStation = (station) => {
  updateModal("station");
  navigateTo(`/area/${route.params.area}/shop/${route.params.typec}`);
};
</script>
